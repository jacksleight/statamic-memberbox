...
return [
    ...
    'member_wizard_intro'                   => 'Members can access the members area of the site and member only content.',
    'member_wizard_invitation_intro'        => 'Send a welcome email with account activation details to the new member.',
    'member_wizard_invitation_share_before' => 'After creating a member, details will be provided to share with <code>:email</code> via your preferred method.',
