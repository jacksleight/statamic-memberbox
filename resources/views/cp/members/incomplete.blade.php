...
@section('content')
    ...
    <div class="min-h-screen flex justify-center jstw-pt-30">
        <div class="text-center">
            <h1 class="text-3xl tracking-tight jstw-mb-4 opacity-50 text-center">{{ __('Roles/Groups Not Configured') }}</h1>
            <p>
