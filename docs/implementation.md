...
It's up to you exactly how you want to implement the Memberbox features on your site, check the [customisation](customisation.html) documentation for details on customising the form pages, invitiation emails and control panel. When it comes to protecting front-end content Memberbox comes with a couple of bonus tags, but Statamic provides almost everying you might need already.
